...
from typing import Optional, Dict, Any, List, Type, cast
...
class APIError(SREAnalyticsError):
    ...
    def __init__(self, message: str, status_code: Optional[int] = None,
                 response_body: Optional[str] = None, context: Optional[Dict[str, Any]] = None):
...
def wrap_exception(exc: Exception, new_type: type, message: str,
                   context: Optional[Dict[str, Any]] = None) -> SREAnalyticsError:
    """
