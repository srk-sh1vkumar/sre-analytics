...
class ConfigurationLoader:
    ...
    def _get_default_slo_config(self) -> Dict[str, Any]:
        ...
        return {
            "availability": {"target": 99.9, "sla": 99.5, "unit": "%"},
            "latency_p95": {"target": 200, "sla": 300, "unit": "ms"},
            "error_rate": {"target": 1.0, "sla": 2.0, "unit": "%"},
        }

    def _get_default_sla_config(self) -> Dict[str, Any]:
        """Get default SLA configuration"""
        return {
            "thresholds": {"availability_min": 99.5, "latency_p95_max": 300, "error_rate_max": 2.0},
            "reporting": {"frequency": "daily", "retention_days": 90},
        }
